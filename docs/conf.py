...
exclude_patterns = [
    '_build', 'Thumbs.db', '.DS_Store', "reference/modules.rst"]
...
latex_documents = [
    (master_doc, 'your_package.tex', 'your\\_package Documentation',
     'you', 'manual'),
]
...
man_pages = [
    (master_doc, 'your_package', 'your_package Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'your_package', 'your_package Documentation',
     author, 'your_package', 'One line description of project.',
     'Miscellaneous'),
]
